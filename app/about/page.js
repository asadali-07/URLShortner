    ...
    <div className="min-h-screen bg-purple-50 flex items-center justify-center">
      <div className="max-w-2xl bg-purple-100 p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-600 mb-4">
          Welcome to our URL shortener app! Our service allows you to take long URLs and convert them into short, easy-to-share links. Whether you're sharing links on social media, in emails, or anywhere else, our tool makes it simple and efficient.
        </p>
        <p className="text-gray-600 mb-4">
